...
def test_has_market_trade_activity_false_for_no_trade_tokens():
    report = MarketReport(
        ...
        down_token_id="down",
        tokens=[
            TokenReport(token_id="up", side="YES", outcome="Up", trade_count=0),
            TokenReport(token_id="down", side="NO", outcome="Down", trade_count=0),
        ],
    )
...
def test_has_market_trade_activity_true_when_any_token_traded():
    report = MarketReport(
        ...
        down_token_id="down",
        tokens=[
            TokenReport(token_id="up", side="YES", outcome="Up", trade_count=1),
            TokenReport(token_id="down", side="NO", outcome="Down", trade_count=0),
        ],
    )
